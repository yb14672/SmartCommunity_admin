...
public enum ResultCode {
    ...
    USER_INFO_GET_FAIL(2022,"业主信息获取失败"),
    ...
    PASSWORD_ILLEGAL(3026,"密码不合规" ),
    USER_REPEAT(3027,"导入有重复" ),
    FILE_REPEAT(3028,"导入文件有重复" ),
    DATA_REPEAT(3029,"数据不能为空" ),
    USERNAME_REPEAT(3030,"用户名有重复" ),
    EMAIL_REPEAT(3031,"邮箱有重复" ),
    ...
    COMMUNITY_GET_FAIL(3036,"小区信息获取失败"),
    COMMUNITY_ADD_FAIL(3037,"新增小区失败"),
    REPEAT_COMMUNITY_NAME(3038,"小区名重复"),
    COMMUNITY_UPDATE_FAIL(3039,"小区修改失败"),
    COMMUNITY_DELETE_FAIL(3040,"小区删除失败"),
    PARENT_CLASS_DEACTIVATE(3041,"父类已被停用" ),
    PARENT_CANNOT_BE_A_SUBSET(3042,"父类不能是自己的子集" ),
    TEL_NON_COMPLIANCE(3043,"电话号码不符合规则" ),
    EMAIL_NON_COMPLIANCE(3044,"邮箱不符合规则" ),
    MASSAGE_NULL(3045,"信息为空" ),
    BUILDING_REPEAT(3046,"楼层重复" ),
    BUILDING_NAME_REPEAT(3047,"楼层名字重复" ),
    BUILD_IDENTICAL(3048,"楼层信息完全相同" ),
    BUILD_HAVA_CHILD(3049,"楼层下面有单元不允许删除" ),
    UNIT_ADD_FAIL(3050,"单元新增失败"),
    UNIT_UPDATE_FAIL(3051,"单元修改失败"),
    UNIT_NAME_REPEAT(3052,"单元名重复"),
    UNIT_HAVE_PEOPLE(3053,"单元存在住户，不能删除"),
    COMMUNITY_HAVE_CHILD(3054,"小区存在楼栋，不能删除"),
    COMPANY_OWNS_PROPERTY(3055,"公司仍有负责的物业，不能删除"),
    ROOM_HAVE_BEEN(3056,"该房屋名在其他楼层下已存在"),
